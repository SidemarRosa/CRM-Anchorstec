...
<?php endif; ?>
<!-- Tabela de contas a pagar com estilo suave -->
<div class="row mb-4">
    <div class="col-md-11 mx-auto">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                <h6 class="mb-0">Contas a Pagar</h6>
                <button id="btn-nova-conta" class="btn btn-danger btn-sm">
...
<div id="modal-form" class="d-none position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center" style="z-index: 1050; background-color: rgba(0, 0, 0, 0.5);">
    <div class="card shadow-lg" style="width: 90%; max-width: 700px;">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Adicionar Nova Conta a Pagar</h5>
            <button type="button" id="btn-fechar-form" class="btn-close"></button>
        </div>
        <div class="card-body">
            <form action="<?= base_url('contasapagar/create') ?>" method="post">
                <div class="row mb-3">
                    <div class="col-md-6">
